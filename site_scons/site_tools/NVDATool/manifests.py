...
def generateTranslatedManifest(
	...
	with codecs.open(source, "r", "utf-8") as f:
		manifest_template = f.read()
	# Fallbacks: eski tool sürümlerinde bu alanlar yoksa KeyError olmasın
	for _k in ("addon_changelog", "addon_summary", "addon_description"): # 123 kaldırılacak
		vars.setdefault(_k, "") # 123 kaldırılacak
